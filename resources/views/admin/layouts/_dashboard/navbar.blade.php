        ...
        <ul class="dropdown-menu dropdown-menu-end py-0 hide-arrow" data-bs-popper="static">
          ...
          <li class="dropdown-notifications-list scrollable-container ps">
            <ul class="list-group list-group-flush" style="width:300px;">
              ...
              <li class="list-group-item list-group-item-action dropdown-notifications-item item-notif-list-1 cursor-pointer">
                <div class="d-flex">
                  ...
                  <div class="flex-grow-1">
                    ...
                    <small class="text-muted">1 months age</small>
                   
                  </div>
                  <div class="flex-shrink-0 dropdown-notifications-actions">
                    <a href="javascript:void(0)" class="dropdown-notifications-read"><span class="badge badge-dot"></span></a>
                    <a href="javascript:void(0)" class="dropdown-notifications-archive close-notif" data-toggle="tooltip" data-placement="right" title="Click to make this notifications read" data-close="1" ><span class="bx bx-x"></span></a>
                  </div>
                </div>
              </li>
